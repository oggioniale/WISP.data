...
•	maxPeak_blue (numeric): maximum allowed threshold for the blue spectral region. Default: 0.02;
...
•	aggregate (character): defines how temporal aggregation is applied:
   ...
   -	daily_mean: calculates the daily mean and adds a ribbon representing the standard deviation
...
```{r, warning=FALSE, message=TRUE, out.width="100%"}
